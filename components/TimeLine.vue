<template>
  <section id='scroll-box' class='section pp-scrollable bg-themeColor hide-scroll-bar'>
    <div class='max-w-3xl mx-auto'>
      <p class='text-secondaryColor text-right font-bold tracking-widest pr-6 md:pr-0 pt-16'>2021年 岡山大学祭テーマ</p>
      <h1 class='text-white text-4xl text-right tracking-extraWidest mt-2 pr-6 md:pr-0'>笑顔満祭岡大祭</h1>
      <p class='text-white text-right text-base tracking-widest mt-3 pr-6 md:pr-0'>〜心機一転しちゃいな祭〜</p>
      <ul class='timeline'>
      ...
      <a v-for='n in 3' :key='n' href='#' class='block mt-40'>
        Twitter
      </a>
    </div>
  </section>
